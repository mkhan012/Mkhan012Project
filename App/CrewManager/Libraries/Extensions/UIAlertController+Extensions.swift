...
extension UIAlertController {
    ...
    convenience init(style: UIAlertController.Style, source: UIView? = nil, title: String? = nil, message: String? = nil, tintColor: UIColor? = nil) {
        ...
        let root = UIApplication.key_Window?.rootViewController?.view
...
extension UIAlertController {
    ...
    public func show(animated: Bool = true, vibrate: Bool = false, style: UIBlurEffect.Style? = nil, completion: (() -> Void)? = nil) {
        ...
        DispatchQueue.main.async {
            UIApplication.key_Window?.endEditing(true)
            

            if var topController = UIApplication.key_Window?.rootViewController {
                ...
                UIApplication.key_Window?.rootViewController?.present(self, animated: animated, completion: completion)
            }
